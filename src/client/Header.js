...
function Header() {
    ...
    return (
        <header className="navbar navbar-dark bg-dark shadow-sm">
          <div className="navbar-nav-scroll paddingLeft200">
            <ul className="navbar-nav bd-navbar-nav flex-row">
            <NavLink exact className="navbar-brand d-flex align-items-center" to="/">
            ...
            <NavLink exact className="navbar-brand d-flex align-items-center" to="/meals">
          ...
          <div className="container" style={{justifyContent:'left'}}>
            <a className="navbar-brand d-flex align-items-right" href="https://github.com/twbs/bootstrap" target="_blank" rel="noopener" aria-label="GitHub">
